...
import { CalculateAge } from '../helpers/helper.js';
    ...
    render() {
        return (
            <div className='format-styling'>
                ...
                <p>
                    My name's Max Goddard and I'm a {CalculateAge(new Date('2000', '08', '05'))} year old British software developer living in Manchester, England. 

                    I've been working for {CalculateAge(new Date('2018', '01', '01'))} years since 2018 and I'm currently working for an agency,
